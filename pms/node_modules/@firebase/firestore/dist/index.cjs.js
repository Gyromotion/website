...
function documentSnapshotFromJSON(t, e, n) {
    if (common.__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
        if (e.bundle === Xt) throw new common.FirestoreError(common.D.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
        // Parse the bundle data.
                const r = common.__PRIVATE_newSerializer(t._databaseId), s = common.__PRIVATE_createBundleReaderSync(e.bundle, r), a = s.t(), o = new common.__PRIVATE_BundleLoader(s.getMetadata(), r);
        ...
        // Build out the internal document data.
                const c = common.fromDocument(r, i[0].document), h = new common.DocumentKey(common.ResourcePath.fromString(e.bundleName));
 ...
 */ class __PRIVATE_TestingHooksSpiImpl {
    ...
    static get instance() {
        return ee || (ee = new __PRIVATE_TestingHooksSpiImpl, common.__PRIVATE_setTestingHooksSpi(ee)), ee;
    }
    u(t) {
 ...
 */ !function __PRIVATE_registerFirestore(h, d = !0) {
    ...
    }), "PUBLIC").setMultipleInstances(!0)), app.registerVersion(Yt, Kt, h), 
    // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
    app.registerVersion(Yt, Kt, "cjs2020");
}();

exports.AbstractUserDataWriter = common.AbstractUserDataWriter;
exports.Bytes = common.Bytes;
exports.CACHE_SIZE_UNLIMITED = common.fn;

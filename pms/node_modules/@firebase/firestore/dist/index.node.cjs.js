...
function registerFirestore(variant, useFetchStreams = true) {
    common30385a2e_node.setSDKVersion(app.SDK_VERSION);
    app._registerComponent(new component.Component('firestore', (container, { instanceIdentifier: databaseId, options: settings }) => {
        ...
        const firestoreInstance = new common30385a2e_node.Firestore(new common30385a2e_node.FirebaseAuthCredentialsProvider(container.getProvider('auth-internal')), new common30385a2e_node.FirebaseAppCheckTokenProvider(app, container.getProvider('app-check-internal')), common30385a2e_node.databaseIdFromApp(app, databaseId), app);
...
class AggregateQuerySnapshot {
    ...
    _fieldsProto() {
        ...
        const dataClone = new common30385a2e_node.ObjectValue({
...
class DocumentSnapshot$1 {
     ...
     */
    get ref() {
        return new common30385a2e_node.DocumentReference(this._firestore, this._converter, this._key);
    }
    /**
    ...
    get(fieldPath) {
        if (this._document) {
            const value = this._document.data.field(common30385a2e_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
            if (value !== null) {
...
function validateHasExplicitOrderByForLimitToLast(query) {
    if (query.limitType === "L" /* LimitType.Last */ &&
        ...
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.UNIMPLEMENTED, 'limitToLast() queries require specifying at least one orderBy() clause');
    }
}
/**
...
class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _apply(query) {
        ...
        return new common30385a2e_node.Query(query.firestore, query.converter, common30385a2e_node.queryWithAddedFilter(query._query, filter));
    }
    _parse(query) {
        const reader = common30385a2e_node.newUserDataReader(query.firestore);
...
function where(fieldPath, opStr, value) {
    const op = opStr;
    const field = common30385a2e_node.fieldPathFromArgument('where', fieldPath);
...
class QueryCompositeFilterConstraint extends AppliableConstraint {
    ...
    _parse(query) {
        ...
        return common30385a2e_node.CompositeFilter.create(parsedFilters, this._getOperator());
    }
    _apply(query) {
        ...
        return new common30385a2e_node.Query(query.firestore, query.converter, common30385a2e_node.queryWithAddedFilter(query._query, parsedFilter));
    }
...
class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(query) {
        ...
        return new common30385a2e_node.Query(query.firestore, query.converter, common30385a2e_node.queryWithAddedOrderBy(query._query, orderBy));
    }
}
/**
...
function orderBy(fieldPath, directionStr = 'asc') {
    ...
    const path = common30385a2e_node.fieldPathFromArgument('orderBy', fieldPath);
...
class QueryLimitConstraint extends QueryConstraint {
    ...
    _apply(query) {
        return new common30385a2e_node.Query(query.firestore, query.converter, common30385a2e_node.queryWithLimit(query._query, this._limit, this._limitType));
    }
}
/**
...
function limit(limit) {
    common30385a2e_node.validatePositiveNumber('limit', limit);
...
function limitToLast(limit) {
    common30385a2e_node.validatePositiveNumber('limitToLast', limit);
...
class QueryStartAtConstraint extends QueryConstraint {
    ...
    _apply(query) {
        ...
        return new common30385a2e_node.Query(query.firestore, query.converter, common30385a2e_node.queryWithStartAt(query._query, bound));
    }
}
...
class QueryEndAtConstraint extends QueryConstraint {
    ...
    _apply(query) {
        const bound = newQueryBoundFromDocOrFields(query, this.type, this._docOrFields, this._inclusive);
        return new common30385a2e_node.Query(query.firestore, query.converter, common30385a2e_node.queryWithEndAt(query._query, bound));
    }
}
...
function newQueryFilter(query, methodName, dataReader, databaseId, fieldPath, op, value) {
    ...
    if (fieldPath.isKeyField()) {
        if (op === "array-contains" /* Operator.ARRAY_CONTAINS */ || op === "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid Query. You can't perform '${op}' queries on documentId().`);
        }
        ...
        fieldValue = common30385a2e_node.parseQueryValue(dataReader, methodName, value, 
        /* allowArrays= */ op === "in" /* Operator.IN */ || op === "not-in" /* Operator.NOT_IN */);
    }
    const filter = common30385a2e_node.FieldFilter.create(fieldPath, op, fieldValue);
    return filter;
}
function newQueryOrderBy(query, fieldPath, direction) {
    if (query.startAt !== null) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Invalid query. You must not call startAt() or startAfter() before ' +
            'calling orderBy().');
    }
    if (query.endAt !== null) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Invalid query. You must not call endAt() or endBefore() before ' +
            'calling orderBy().');
    }
    const orderBy = new common30385a2e_node.OrderBy(fieldPath, direction);
    return orderBy;
}
/**
...
function newQueryBoundFromDocument(query, databaseId, methodName, doc, inclusive) {
    if (!doc) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ` +
            `${methodName}().`);
    }
    const components = [];
    ...
    // results.
    for (const orderBy of common30385a2e_node.queryNormalizedOrderBy(query)) {
        if (orderBy.field.isKeyField()) {
            components.push(common30385a2e_node.refValue(databaseId, doc.key));
        }
        else {
            const value = doc.data.field(orderBy.field);
            if (common30385a2e_node.isServerTimestamp(value)) {
                throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a ' +
    ...
    return new common30385a2e_node.Bound(components, inclusive);
}
/**
...
function newQueryBoundFromFields(query, databaseId, dataReader, methodName, values, inclusive) {
    ...
    if (values.length > orderBy.length) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Too many arguments provided to ${methodName}(). ` +
    ...
    for (let i = 0; i < values.length; i++) {
        ...
        if (orderByComponent.field.isKeyField()) {
            if (typeof rawValue !== 'string') {
                throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ` +
                    `${methodName}(), but got a ${typeof rawValue}`);
            }
            if (!common30385a2e_node.isCollectionGroupQuery(query) && rawValue.indexOf('/') !== -1) {
                throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), ` +
                    `the value passed to ${methodName}() must be a plain document ID, but ` +
                    `'${rawValue}' contains a slash.`);
            }
            const path = query.path.child(common30385a2e_node.ResourcePath.fromString(rawValue));
            if (!common30385a2e_node.DocumentKey.isDocumentKey(path)) {
                throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by ` +
                    `documentId(), the value passed to ${methodName}() must result in a ` +
                    `valid document path, but '${path}' is not because it contains an odd number ` +
                    `of segments.`);
            }
            const key = new common30385a2e_node.DocumentKey(path);
            components.push(common30385a2e_node.refValue(databaseId, key));
        }
        else {
            const wrapped = common30385a2e_node.parseQueryValue(dataReader, methodName, rawValue);
...
function parseDocumentIdValue(databaseId, query, documentIdValue) {
    ...
    if (typeof documentIdValue === 'string') {
        if (documentIdValue === '') {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Invalid query. When querying with documentId(), you ' +
                'must provide a valid document ID, but it was an empty string.');
        }
        if (!common30385a2e_node.isCollectionGroupQuery(query) && documentIdValue.indexOf('/') !== -1) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection by ` +
                `documentId(), you must provide a plain document ID, but ` +
                `'${documentIdValue}' contains a '/' character.`);
        }
        const path = query.path.child(common30385a2e_node.ResourcePath.fromString(documentIdValue));
        if (!common30385a2e_node.DocumentKey.isDocumentKey(path)) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group by ` +
                `documentId(), the value provided must result in a valid document path, ` +
                `but '${path}' is not because it has an odd number of segments (${path.length}).`);
        }
        return common30385a2e_node.refValue(databaseId, new common30385a2e_node.DocumentKey(path));
    }
    else if (documentIdValue instanceof common30385a2e_node.DocumentReference) {
        return common30385a2e_node.refValue(databaseId, documentIdValue._key);
    }
    else {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid ` +
            `string or a DocumentReference, but it was: ` +
            `${common30385a2e_node.valueDescription(documentIdValue)}.`);
    }
}
/**
...
function validateDisjunctiveFilterElements(value, operator) {
    if (!Array.isArray(value) || value.length === 0) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Invalid Query. A non-empty array is required for ' +
...
function validateNewFieldFilter(query, fieldFilter) {
    ...
    if (conflictingOp !== null) {
        ...
        if (conflictingOp === fieldFilter.op) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Invalid query. You cannot use more than one ' +
                `'${fieldFilter.op.toString()}' filter.`);
        }
        else {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Invalid query. You cannot use '${fieldFilter.op.toString()}' filters ` +
...
function validateNewFilter(query, filter) {
    ...
    for (const subFilter of subFilters) {
        ...
        testQuery = common30385a2e_node.queryWithAddedFilter(testQuery, subFilter);
    }
}
...
function validateQueryFilterConstraint(functionName, queryConstraint) {
    if (!(queryConstraint instanceof QueryFieldFilterConstraint) &&
        ...
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Function ${functionName}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
    }
}
function validateQueryConstraintArray(queryConstraint) {
    ...
    if (compositeFilterCount > 1 ||
        ...
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'InvalidQuery. When using composite filters, you cannot use ' +
...
class LiteUserDataWriter extends common30385a2e_node.AbstractUserDataWriter {
    constructor(firestore) {
        super();
        this.firestore = firestore;
    }
    convertBytes(bytes) {
        return new common30385a2e_node.Bytes(bytes);
    }
    convertReference(name) {
        const key = this.convertDocumentKey(name, this.firestore._databaseId);
        return new common30385a2e_node.DocumentReference(this.firestore, /* converter= */ null, key);
    }
}
 ...
 */
function sum(field) {
    return new AggregateField('sum', common30385a2e_node.fieldPathFromArgument('sum', field));
}
/**
...
function average(field) {
    return new AggregateField('avg', common30385a2e_node.fieldPathFromArgument('average', field));
}
/**
...
function aggregateQuerySnapshotEqual(left, right) {
    return (common30385a2e_node.queryEqual(left.query, right.query) && util.deepEqual(left.data(), right.data()));
}
...
function getAggregateFromServer(query, aggregateSpec) {
    const firestore = common30385a2e_node.cast(query.firestore, common30385a2e_node.Firestore);
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    const internalAggregates = common30385a2e_node.mapToArray(aggregateSpec, (aggregate, alias) => {
        return new common30385a2e_node.AggregateImpl(alias, aggregate.aggregateType, aggregate._internalFieldPath);
    });
    // Run the aggregation and convert the results
    return common30385a2e_node.firestoreClientRunAggregateQuery(client, query._query, internalAggregates).then(aggregateResult => convertToAggregateQuerySnapshot(firestore, query, aggregateResult));
}
/**
...
class MemoryLocalCacheImpl {
    constructor(settings) {
        this.kind = 'memory';
        this._onlineComponentProvider = common30385a2e_node.OnlineComponentProvider.provider;
        if (settings?.garbageCollector) {
            ...
            this._offlineComponentProvider = {
                build: () => new common30385a2e_node.LruGcMemoryOfflineComponentProvider(undefined)
            };
        }
    }
    toJSON() {
...
class MemoryEagerGarbageCollectorImpl {
    constructor() {
        ...
        this._offlineComponentProvider = common30385a2e_node.MemoryOfflineComponentProvider.provider;
    }
    toJSON() {
        return { kind: this.kind };
    }
...
class MemoryLruGarbageCollectorImpl {
    constructor(cacheSize) {
        this.kind = 'memoryLru';
        this._offlineComponentProvider = {
            build: () => new common30385a2e_node.LruGcMemoryOfflineComponentProvider(cacheSize)
        };
    }
    toJSON() {
        return { kind: this.kind };
...
class SingleTabManagerImpl {
    ...
    _initialize(settings) {
        this._onlineComponentProvider = common30385a2e_node.OnlineComponentProvider.provider;
        this._offlineComponentProvider = {
            build: (onlineComponents) => new common30385a2e_node.IndexedDbOfflineComponentProvider(onlineComponents, settings?.cacheSizeBytes, this.forceOwnership)
        };
    }
}
class MultiTabManagerImpl {
    ...
    _initialize(settings) {
        this._onlineComponentProvider = common30385a2e_node.OnlineComponentProvider.provider;
        this._offlineComponentProvider = {
            build: (onlineComponents) => new common30385a2e_node.MultiTabOfflineComponentProvider(onlineComponents, settings?.cacheSizeBytes)
        };
    }
}
/**
...
const encoder = common30385a2e_node.newTextEncoder();
...
class BundleBuilder {
    constructor(firestore, bundleId) {
        ...
        this.latestReadTime = new common30385a2e_node.Timestamp(0, 0);
        ...
        this.serializer = new common30385a2e_node.JsonProtoSerializer(this.databaseId, 
        /*useProto3Json=*/ true);
        this.userDataReader = new common30385a2e_node.UserDataReader(this.databaseId, true, this.serializer);
    }
    /**
    ...
    addBundleDocument(docBundleData, queryName) {
        ...
        const origDocReadTime = !!originalDocument?.metadata
            .readTime
            ? common30385a2e_node.fromTimestamp(originalDocument.metadata.readTime)
            : null;
        ...
        if (neitherHasReadTime || docIsNewer) {
            ...
            this.documents.set(docBundleData.documentPath, {
                ...
                metadata: {
                    name: common30385a2e_node.toName(this.serializer, docBundleData.documentKey),
                    readTime: !!docReadTime
                        ? common30385a2e_node.toTimestamp(this.serializer, docReadTime) // Convert Timestamp to proto format.
                        : undefined,
    ...
    addBundleQuery(queryBundleData) {
        ...
        let latestReadTime = new common30385a2e_node.Timestamp(0, 0);
        ...
        const queryTarget = common30385a2e_node.toQueryTarget(this.serializer, common30385a2e_node.queryToTarget(queryBundleData.query));
        const bundledQuery = {
        ...
        this.namedQueries.set(queryBundleData.name, {
            ...
            bundledQuery,
            readTime: common30385a2e_node.toTimestamp(this.serializer, latestReadTime)
        });
    }
    /**
    ...
    toBundleDocument(docBundleData) {
        ...
        const proto3Fields = common30385a2e_node.parseObject(docBundleData.documentData, context);
        return {
            name: common30385a2e_node.toName(this.serializer, docBundleData.documentKey),
            fields: proto3Fields.mapValue.fields,
            updateTime: common30385a2e_node.toTimestamp(this.serializer, docBundleData.versionTime),
            createTime: common30385a2e_node.toTimestamp(this.serializer, docBundleData.createdTime)
        };
    }
    /**
    ...
    build() {
        ...
        const metadata = {
            id: this.bundleId,
            createTime: common30385a2e_node.toTimestamp(this.serializer, this.latestReadTime),
...
function buildDocumentSnapshotJsonBundle(db, document, docData, path) {
    const builder = new BundleBuilder(db, common30385a2e_node.AutoId.newId());
...
class DocumentSnapshot extends DocumentSnapshot$1 {
    ...
    toJSON() {
        if (this.metadata.hasPendingWrites) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.FAILED_PRECONDITION, 'DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. ' +
...
DocumentSnapshot._jsonSchema = {
    type: common30385a2e_node.property('string', DocumentSnapshot._jsonSchemaVersion),
    bundleSource: common30385a2e_node.property('string', 'DocumentSnapshot'),
    bundleName: common30385a2e_node.property('string'),
    bundle: common30385a2e_node.property('string')
};
function documentSnapshotFromJSON(db, json, converter) {
    if (common30385a2e_node.validateJSON(json, DocumentSnapshot._jsonSchema)) {
        if (json.bundle === NOT_SUPPORTED) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'The provided JSON object was created in a client environment, which is not supported.');
        }
        // Parse the bundle data.
        const serializer = common30385a2e_node.newSerializer(db._databaseId);
        const bundleReader = common30385a2e_node.createBundleReaderSync(json.bundle, serializer);
        const elements = bundleReader.getElements();
        const bundleLoader = new common30385a2e_node.BundleLoader(bundleReader.getMetadata(), serializer);
        ...
        if (bundledDocuments.length !== 1) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${bundledDocuments.length} documents.`);
        }
        // Build out the internal document data.
        const document = common30385a2e_node.fromDocument(serializer, bundledDocuments[0].document);
        const documentKey = new common30385a2e_node.DocumentKey(common30385a2e_node.ResourcePath.fromString(json.bundleName));
...
class QuerySnapshot {
    ...
    docChanges(options = {}) {
        ...
        if (includeMetadataChanges && this._snapshot.excludesMetadataChanges) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'To include metadata changes with your document changes, you must ' +
    ...
    toJSON() {
        if (this.metadata.hasPendingWrites) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.FAILED_PRECONDITION, 'QuerySnapshot.toJSON() attempted to serialize a document with pending writes. ' +
                'Await waitForPendingWrites() before invoking toJSON().');
        }
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const result = {};
        ...
        result['bundleName'] = common30385a2e_node.AutoId.newId();
...
QuerySnapshot._jsonSchema = {
    type: common30385a2e_node.property('string', QuerySnapshot._jsonSchemaVersion),
    bundleSource: common30385a2e_node.property('string', 'QuerySnapshot'),
    bundleName: common30385a2e_node.property('string'),
    bundle: common30385a2e_node.property('string')
};
function querySnapshotFromJSON(db, json, converter) {
    if (common30385a2e_node.validateJSON(json, QuerySnapshot._jsonSchema)) {
        if (json.bundle === NOT_SUPPORTED) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'The provided JSON object was created in a client environment, which is not supported.');
        }
        // Parse the bundle data.
        ...
        if (bundleLoader.queries.length !== 1) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${bundleLoader.queries.length} queries.`);
        }
        // Create an internal Query object from the named query in the bundle.
        const query = common30385a2e_node.fromBundledQuery(bundleLoader.queries[0].bundledQuery);
        // Construct the arrays of document data for the query.
        const bundledDocuments = bundleLoader.documents;
        let documentSet = new common30385a2e_node.DocumentSet();
        bundledDocuments.map(bundledDocument => {
            const document = common30385a2e_node.fromDocument(serializer, bundledDocument.document);
            documentSet = documentSet.add(document);
        });
        // Create a view snapshot of the query and documents.
        const viewSnapshot = common30385a2e_node.ViewSnapshot.fromInitialDocuments(query, documentSet, common30385a2e_node.documentKeySet() /* Zero mutated keys signifies no pending writes. */, 
        /* fromCache= */ false, 
        /* hasCachedResults= */ false);
        // Create an external Query object, required to construct the QuerySnapshot.
        const externalQuery = new common30385a2e_node.Query(db, converter ? converter : null, query);
...
function changesFromSnapshot(querySnapshot, includeMetadataChanges) {
    if (querySnapshot._snapshot.oldDocs.isEmpty()) {
        ...
        return querySnapshot._snapshot.docChanges.map(change => {
            common30385a2e_node.isPipeline(querySnapshot._snapshot.query)
                ? common30385a2e_node.newPipelineComparator(querySnapshot._snapshot.query)
                : common30385a2e_node.newQueryComparator(querySnapshot.query._query);
...
function resultChangeType(type) {
    switch (type) {
        ...
        case 1 /* ChangeType.Removed */:
            return 'removed';
        default:
            return common30385a2e_node.fail(0xf03d, { type });
    }
}
...
function snapshotEqual(left, right) {
    if (left instanceof DocumentSnapshot && right instanceof DocumentSnapshot) {
        ...
        return (left._firestore === right._firestore &&
            common30385a2e_node.queryEqual(left.query, right.query) &&
...
function validateTransactionOptions(options) {
    if (options.maxAttempts < 1) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Max attempts must be at least 1');
    }
}
...
class WriteBatch {
    ...
    constructor(_firestore, _commitHandler) {
        ...
        this._dataReader = common30385a2e_node.newUserDataReader(_firestore);
    }
    set(documentRef, data, options) {
        this._verifyNotCommitted();
        const ref = validateReference(documentRef, this._firestore);
        const convertedValue = applyFirestoreDataConverter(ref.converter, data, options);
        const parsed = common30385a2e_node.parseSetData(this._dataReader, 'WriteBatch.set', ref._key, convertedValue, ref.converter !== null, options);
        this._mutations.push(parsed.toMutation(ref._key, common30385a2e_node.Precondition.none()));
        return this;
    }
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        ...
        if (typeof fieldOrUpdateData === 'string' ||
            fieldOrUpdateData instanceof common30385a2e_node.FieldPath) {
            parsed = common30385a2e_node.parseUpdateVarargs(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = common30385a2e_node.parseUpdateData(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData);
        }
        this._mutations.push(parsed.toMutation(ref._key, common30385a2e_node.Precondition.exists(true)));
        return this;
    }
    /**
    ...
    delete(documentRef) {
        this._verifyNotCommitted();
        const ref = validateReference(documentRef, this._firestore);
        this._mutations = this._mutations.concat(new common30385a2e_node.DeleteMutation(ref._key, common30385a2e_node.Precondition.none()));
        return this;
    }
    /**
    ...
    _verifyNotCommitted() {
        if (this._committed) {
            throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.FAILED_PRECONDITION, 'A write batch can no longer be used after commit() ' +
                'has been called.');
        }
    }
}
function validateReference(documentRef, firestore) {
    ...
    if (documentRef.firestore !== firestore) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Provided document reference is from a different Firestore instance.');
    }
    else {
        return documentRef;
    }
...
class Transaction$1 {
    ...
    get(documentRef) {
        ...
        return this._transaction.lookup([ref._key]).then(docs => {
            if (!docs || docs.length !== 1) {
                return common30385a2e_node.fail(0x5de9);
            }
            const doc = docs[0];
            if (doc.isFoundDocument()) {
                ...
                throw common30385a2e_node.fail(0x4801, {
                    doc
                });
            }
        });
    ...
    set(documentRef, value, options) {
        ...
        const parsed = common30385a2e_node.parseSetData(this._dataReader, 'Transaction.set', ref._key, convertedValue, ref.converter !== null, options);
    ...
    update(documentRef, fieldOrUpdateData, value, ...moreFieldsAndValues) {
        ...
        if (typeof fieldOrUpdateData === 'string' ||
            fieldOrUpdateData instanceof common30385a2e_node.FieldPath) {
            parsed = common30385a2e_node.parseUpdateVarargs(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = common30385a2e_node.parseUpdateData(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData);
        }
...
class Transaction extends Transaction$1 {
    ...
    get(documentRef) {
        const ref = validateReference(documentRef, this._firestore);
        const userDataWriter = new common30385a2e_node.ExpUserDataWriter(this._firestore);
        return super
            .get(documentRef)
...
function runTransaction(firestore, updateFunction, options) {
    firestore = common30385a2e_node.cast(firestore, common30385a2e_node.Firestore);
    ...
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    return common30385a2e_node.firestoreClientTransaction(client, internalTransaction => updateFunction(new Transaction(firestore, internalTransaction)), optionsWithDefaults);
}
...
function getDoc(reference) {
    reference = common30385a2e_node.cast(reference, common30385a2e_node.DocumentReference);
    const firestore = common30385a2e_node.cast(reference.firestore, common30385a2e_node.Firestore);
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    return common30385a2e_node.firestoreClientGetDocumentViaSnapshotListener(client, reference._key).then(snapshot => convertToDocSnapshot(firestore, reference, snapshot));
}
/**
...
function getDocFromCache(reference) {
    ...
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common30385a2e_node.ExpUserDataWriter(firestore);
    return common30385a2e_node.firestoreClientGetDocumentFromLocalCache(client, reference._key).then(doc => new DocumentSnapshot(firestore, userDataWriter, reference._key, doc, new SnapshotMetadata(doc !== null && doc.hasLocalMutations, 
...
function getDocFromServer(reference) {
    ...
    const firestore = common30385a2e_node.cast(reference.firestore, common30385a2e_node.Firestore);
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    return common30385a2e_node.firestoreClientGetDocumentViaSnapshotListener(client, reference._key, {
        source: 'server'
    }).then(snapshot => convertToDocSnapshot(firestore, reference, snapshot));
}
function getDocs(query) {
    query = common30385a2e_node.cast(query, common30385a2e_node.Query);
    const firestore = common30385a2e_node.cast(query.firestore, common30385a2e_node.Firestore);
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common30385a2e_node.ExpUserDataWriter(firestore);
    validateHasExplicitOrderByForLimitToLast(query._query);
    return common30385a2e_node.firestoreClientGetDocumentsViaSnapshotListener(client, query._query).then(snapshot => new QuerySnapshot(firestore, userDataWriter, query, snapshot));
}
/**
...
function getDocsFromCache(query) {
    ...
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common30385a2e_node.ExpUserDataWriter(firestore);
    return common30385a2e_node.firestoreClientGetDocumentsFromLocalCache(client, query._query).then(snapshot => new QuerySnapshot(firestore, userDataWriter, query, snapshot));
}
/**
...
function getDocsFromServer(query) {
    ...
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common30385a2e_node.ExpUserDataWriter(firestore);
    return common30385a2e_node.firestoreClientGetDocumentsViaSnapshotListener(client, query._query, {
        source: 'server'
...
function setDoc(reference, data, options) {
    ...
    const dataReader = common30385a2e_node.newUserDataReader(firestore);
    const parsed = common30385a2e_node.parseSetData(dataReader, 'setDoc', reference._key, convertedValue, reference.converter !== null, options);
    const mutation = parsed.toMutation(reference._key, common30385a2e_node.Precondition.none());
...
function updateDoc(reference, fieldOrUpdateData, value, ...moreFieldsAndValues) {
    ...
    if (typeof fieldOrUpdateData === 'string' ||
        fieldOrUpdateData instanceof common30385a2e_node.FieldPath) {
        parsed = common30385a2e_node.parseUpdateVarargs(dataReader, 'updateDoc', reference._key, fieldOrUpdateData, value, moreFieldsAndValues);
    }
    else {
        parsed = common30385a2e_node.parseUpdateData(dataReader, 'updateDoc', reference._key, fieldOrUpdateData);
    }
    const mutation = parsed.toMutation(reference._key, common30385a2e_node.Precondition.exists(true));
    return executeWrite(firestore, [mutation]);
}
/**
...
function deleteDoc(reference) {
    const firestore = common30385a2e_node.cast(reference.firestore, common30385a2e_node.Firestore);
    const mutations = [new common30385a2e_node.DeleteMutation(reference._key, common30385a2e_node.Precondition.none())];
...
function addDoc(reference, data) {
    const firestore = common30385a2e_node.cast(reference.firestore, common30385a2e_node.Firestore);
    const docRef = common30385a2e_node.doc(reference);
    const convertedValue = applyFirestoreDataConverter(reference.converter, data);
    const dataReader = common30385a2e_node.newUserDataReader(reference.firestore);
    const parsed = common30385a2e_node.parseSetData(dataReader, 'addDoc', docRef._key, convertedValue, reference.converter !== null, {});
    const mutation = parsed.toMutation(docRef._key, common30385a2e_node.Precondition.exists(false));
...
function onSnapshot(reference, ...args) {
    ...
    let firestore;
    let internalQuery;
    if (reference instanceof common30385a2e_node.DocumentReference) {
        firestore = common30385a2e_node.cast(reference.firestore, common30385a2e_node.Firestore);
        internalQuery = common30385a2e_node.newQueryForPath(reference._key.path);
        observer = {
            next: snapshot => {
                if (args[currArg]) {
        ...
        const query = common30385a2e_node.cast(reference, common30385a2e_node.Query);
        firestore = common30385a2e_node.cast(query.firestore, common30385a2e_node.Firestore);
    ...
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    return common30385a2e_node.firestoreClientListen(client, internalQuery, internalOptions, observer);
}
function onSnapshotResume(reference, snapshotJson, ...args) {
    ...
    if (json.error) {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, json.error);
    }
    let curArg = 0;
    ...
    if (json.bundleSource === 'QuerySnapshot') {
        ...
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, `unsupported bundle source: ${json.bundleSource}`);
    }
}
function onSnapshotsInSync(firestore, arg) {
    ...
    return common30385a2e_node.firestoreClientAddSnapshotsInSyncListener(client, observer);
}
/**
...
function executeWrite(firestore, mutations) {
    const client = common30385a2e_node.ensureFirestoreConfigured(firestore);
    return common30385a2e_node.firestoreClientWrite(client, mutations);
}
/**
...
function onSnapshotDocumentSnapshotBundle(db, json, options, observer, converter) {
    ...
    const loadTask = common30385a2e_node.loadBundle(db, json.bundle);
    loadTask
        .then(() => {
        if (!unsubscribed) {
            const docReference = new common30385a2e_node.DocumentReference(db, converter ? converter : null, common30385a2e_node.DocumentKey.fromPath(json.bundleName));
...
function onSnapshotQuerySnapshotBundle(db, json, options, observer, converter) {
    ...
    const loadTask = common30385a2e_node.loadBundle(db, json.bundle);
    loadTask
        .then(() => common30385a2e_node.namedQuery(db, json.bundleName))
        .then(query => {
...
function writeBatch(firestore) {
    firestore = common30385a2e_node.cast(firestore, common30385a2e_node.Firestore);
    common30385a2e_node.ensureFirestoreConfigured(firestore);
...
function setIndexConfiguration(firestore, jsonOrConfiguration) {
    ...
    if (!client._uninitializedComponentsProvider ||
        ...
        common30385a2e_node.logWarn('Cannot enable indexes when persistence is disabled');
        return Promise.resolve();
    }
    const parsedIndexes = parseIndexes(jsonOrConfiguration);
    return common30385a2e_node.firestoreClientSetIndexConfiguration(client, parsedIndexes);
}
        ...
        for (const index of indexConfiguration.indexes) {
            ...
            if (Array.isArray(index.fields)) {
                for (const field of index.fields) {
                    ...
                    const fieldPath = common30385a2e_node.fieldPathFromDotSeparatedString('setIndexConfiguration', fieldPathString);
                    if (field.arrayConfig === 'CONTAINS') {
                        segments.push(new common30385a2e_node.IndexSegment(fieldPath, 2 /* IndexKind.CONTAINS */));
                    }
                    else if (field.order === 'ASCENDING') {
                        segments.push(new common30385a2e_node.IndexSegment(fieldPath, 0 /* IndexKind.ASCENDING */));
                    }
                    else if (field.order === 'DESCENDING') {
                        segments.push(new common30385a2e_node.IndexSegment(fieldPath, 1 /* IndexKind.DESCENDING */));
                    }
                }
            }
            parsedIndexes.push(new common30385a2e_node.FieldIndex(common30385a2e_node.FieldIndex.UNKNOWN_ID, collectionGroup, segments, common30385a2e_node.IndexState.empty()));
        }
    }
...
function tryParseJson(json) {
    try {
        ...
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Failed to parse JSON: ' + e?.message);
    }
}
function tryGetString(data, property) {
    if (typeof data[property] !== 'string') {
        throw new common30385a2e_node.FirestoreError(common30385a2e_node.Code.INVALID_ARGUMENT, 'Missing string value for: ' + property);
    }
...
function deleteAllPersistentCacheIndexes(indexManager) {
    const client = common30385a2e_node.ensureFirestoreConfigured(indexManager._firestore);
    const promise = common30385a2e_node.firestoreClientDeleteAllFieldIndexes(client);
    promise
        .then(_ => common30385a2e_node.logDebug('deleting all persistent cache indexes succeeded'))
        .catch(error => common30385a2e_node.logWarn('deleting all persistent cache indexes failed', error));
}
function setPersistentCacheIndexAutoCreationEnabled(indexManager, isEnabled) {
    const client = common30385a2e_node.ensureFirestoreConfigured(indexManager._firestore);
    const promise = common30385a2e_node.firestoreClientSetPersistentCacheIndexAutoCreationEnabled(client, isEnabled);
    promise
        .then(_ => common30385a2e_node.logDebug(`setting persistent cache index auto creation ` +
        `isEnabled=${isEnabled} succeeded`))
        .catch(error => common30385a2e_node.logWarn(`setting persistent cache index auto creation ` +
...
class TestingHooksSpiImpl {
    ...
    static get instance() {
        if (!testingHooksSpiImplInstance) {
            ...
            common30385a2e_node.setTestingHooksSpi(testingHooksSpiImplInstance);
        }
...
exports.AbstractUserDataWriter = common30385a2e_node.AbstractUserDataWriter;
exports.Bytes = common30385a2e_node.Bytes;
exports.CACHE_SIZE_UNLIMITED = common30385a2e_node.CACHE_SIZE_UNLIMITED;
exports.CollectionReference = common30385a2e_node.CollectionReference;
exports.DocumentReference = common30385a2e_node.DocumentReference;
exports.FieldPath = common30385a2e_node.FieldPath;
exports.FieldValue = common30385a2e_node.FieldValue;
exports.Firestore = common30385a2e_node.Firestore;
exports.FirestoreError = common30385a2e_node.FirestoreError;
exports.GeoPoint = common30385a2e_node.GeoPoint;
exports.LoadBundleTask = common30385a2e_node.LoadBundleTask;
exports.Query = common30385a2e_node.Query;
exports.Timestamp = common30385a2e_node.Timestamp;
exports.VectorValue = common30385a2e_node.VectorValue;
exports._AutoId = common30385a2e_node.AutoId;
exports._ByteString = common30385a2e_node.ByteString;
exports._DatabaseId = common30385a2e_node.DatabaseId;
exports._DocumentKey = common30385a2e_node.DocumentKey;
exports._EmptyAppCheckTokenProvider = common30385a2e_node.EmptyAppCheckTokenProvider;
exports._EmptyAuthCredentialsProvider = common30385a2e_node.EmptyAuthCredentialsProvider;
exports._FieldPath = common30385a2e_node.FieldPath$1;
exports._cast = common30385a2e_node.cast;
exports._debugAssert = common30385a2e_node.debugAssert;
exports._internalAggregationQueryToProtoRunAggregationQueryRequest = common30385a2e_node._internalAggregationQueryToProtoRunAggregationQueryRequest;
exports._internalQueryToProtoQueryTarget = common30385a2e_node._internalQueryToProtoQueryTarget;
exports._isBase64Available = common30385a2e_node.isBase64Available;
exports._logWarn = common30385a2e_node.logWarn;
exports._validateIsNotUsedTogether = common30385a2e_node.validateIsNotUsedTogether;
exports.arrayRemove = common30385a2e_node.arrayRemove;
exports.arrayUnion = common30385a2e_node.arrayUnion;
exports.clearIndexedDbPersistence = common30385a2e_node.clearIndexedDbPersistence;
exports.collection = common30385a2e_node.collection;
exports.collectionGroup = common30385a2e_node.collectionGroup;
exports.connectFirestoreEmulator = common30385a2e_node.connectFirestoreEmulator;
exports.deleteField = common30385a2e_node.deleteField;
exports.disableNetwork = common30385a2e_node.disableNetwork;
exports.doc = common30385a2e_node.doc;
exports.documentId = common30385a2e_node.documentId$1;
exports.enableIndexedDbPersistence = common30385a2e_node.enableIndexedDbPersistence;
exports.enableMultiTabIndexedDbPersistence = common30385a2e_node.enableMultiTabIndexedDbPersistence;
exports.enableNetwork = common30385a2e_node.enableNetwork;
exports.ensureFirestoreConfigured = common30385a2e_node.ensureFirestoreConfigured;
exports.getFirestore = common30385a2e_node.getFirestore;
exports.increment = common30385a2e_node.increment;
exports.initializeFirestore = common30385a2e_node.initializeFirestore;
exports.loadBundle = common30385a2e_node.loadBundle;
exports.maximum = common30385a2e_node.maximum$1;
exports.minimum = common30385a2e_node.minimum$1;
exports.namedQuery = common30385a2e_node.namedQuery;
exports.queryEqual = common30385a2e_node.queryEqual;
exports.refEqual = common30385a2e_node.refEqual;
exports.serverTimestamp = common30385a2e_node.serverTimestamp;
exports.setLogLevel = common30385a2e_node.setLogLevel;
exports.terminate = common30385a2e_node.terminate;
exports.vector = common30385a2e_node.vector;
exports.waitForPendingWrites = common30385a2e_node.waitForPendingWrites;

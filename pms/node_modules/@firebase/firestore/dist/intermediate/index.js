...
import { _ as s, F as a, a as o, b as i, c, O as h, D as d, d as p, Q as _, e as f, f as m, C as g, g as I, h as S, i as T, j as b, k as P, l as E, m as C, n as v, o as R, p as V, q, r as O, s as M, B, t as N, R as L, u as $, v as W, A as k, w as J, x as G, y as j, z as U, E as H, G as Y, H as K, I as Z, J as tt, K as et, L as nt, M as rt, N as st, P as at, S as ot, T as it, U as ut, V as ct, W as lt, X as ht, Y as dt, Z as pt, $ as _t, a0 as ft, a1 as mt, a2 as yt, a3 as gt, a4 as wt, a5 as It, a6 as At, a7 as St, a8 as Tt, a9 as bt, aa as Pt, ab as Et, ac as Ct, ad as vt, ae as Rt, af as Dt, ag as Ft, ah as Vt, ai as Qt, aj as xt, ak as qt, al as Ot, am as Mt, an as Bt, ao as Nt, ap as Lt, aq as $t, ar as Wt, as as kt, at as Jt, au as Gt, av as jt, aw as Ut } from "./common.js";

export { A as AbstractUserDataWriter, w as Bytes, a_ as CACHE_SIZE_UNLIMITED, aL as CollectionReference, D as DocumentReference, a7 as FieldPath, aN as FieldValue, F as Firestore, l as FirestoreError, aY as GeoPoint, aI as LoadBundleTask, Q as Query, aZ as Timestamp, aW as VectorValue, X as _AutoId, b6 as _ByteString, b0 as _DatabaseId, u as _DocumentKey, b8 as _EmptyAppCheckTokenProvider, b7 as _EmptyAuthCredentialsProvider, b5 as _FieldPath, y as _cast, b4 as _debugAssert, b2 as _internalAggregationQueryToProtoRunAggregationQueryRequest, b1 as _internalQueryToProtoQueryTarget, a$ as _isBase64Available, an as _logWarn, b3 as _validateIsNotUsedTogether, aO as arrayRemove, aP as arrayUnion, ay as clearIndexedDbPersistence, aJ as collection, aK as collectionGroup, az as connectFirestoreEmulator, aQ as deleteField, aA as disableNetwork, ag as doc, ax as documentId, aB as enableIndexedDbPersistence, aC as enableMultiTabIndexedDbPersistence, aD as enableNetwork, z as ensureFirestoreConfigured, aE as getFirestore, aR as increment, aF as initializeFirestore, al as loadBundle, aV as maximum, aU as minimum, am as namedQuery, x as queryEqual, aM as refEqual, aS as serverTimestamp, aX as setLogLevel, aG as terminate, aT as vector, aH as waitForPendingWrites } from "./common.js";

import { getModularInstance as Ht, deepEqual as zt } from "@firebase/util";
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
    if (n[0] = Ht(n[0]), n[0] instanceof DocumentSnapshot$1) return function __PRIVATE_newQueryBoundFromDocument(t, e, n, r, s) {
 ...
 */ function aggregateQuerySnapshotEqual(t, e) {
    return G(t.query, e.query) && zt(t.data(), e.data());
}
...
function documentSnapshotFromJSON(t, e, n) {
    if (ot(e, DocumentSnapshot._jsonSchema)) {
        if (e.bundle === Xt) throw new E(C.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
        ...
        function __PRIVATE_changesFromSnapshot(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => {
                    mt(t._snapshot.query) ? yt(t._snapshot.query) : gt(t.query._query);
...
class WriteBatch {
    ...
    set(t, e, n) {
        ...
        const r = __PRIVATE_validateReference(t, this._firestore), s = __PRIVATE_applyFirestoreDataConverter(r.converter, e, n), a = It(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, n);
        return this._mutations.push(a.toMutation(r._key, At.none())), this;
    }
    update(t, e, n, ...r) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let a;
        return a = "string" == typeof (e = Ht(e)) || e instanceof St ? Tt(this._dataReader, "WriteBatch.update", s._key, e, n, r) : bt(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(a.toMutation(s._key, At.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        ...
        return this._mutations = this._mutations.concat(new Pt(e._key, At.none())), this;
    }
    /**
...
function __PRIVATE_validateReference(t, e) {
    if ((t = Ht(t)).firestore !== e) throw new E(C.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ class Transaction$1 {
     ...
     */    get(t) {
        ...
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return wt(24041);
            const r = t[0];
    ...
    set(t, e, n) {
        const r = __PRIVATE_validateReference(t, this._firestore), s = __PRIVATE_applyFirestoreDataConverter(r.converter, e, n), a = It(this._dataReader, "Transaction.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let a;
        return a = "string" == typeof (e = Ht(e)) || e instanceof St ? Tt(this._dataReader, "Transaction.update", s._key, e, n, r) : bt(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ function runTransaction(t, e, n) {
    ...
    const s = U(t);
    return Et(s, (n => e(new Transaction(t, n))), r);
}
 ...
 */ function getDoc(t) {
    ...
    return Ct(n, t._key).then((n => __PRIVATE_convertToDocSnapshot(e, t, n)));
}
 ...
 */ function getDocFromCache(t) {
    ...
    return vt(n, t._key).then((n => new DocumentSnapshot(e, r, t._key, n, new SnapshotMetadata(null !== n && n.hasLocalMutations, 
...
function getDocs(t) {
    t = j(t, _);
    const e = j(t.firestore, a), n = U(e), r = new K(e);
    return __PRIVATE_validateHasExplicitOrderByForLimitToLast(t._query), Rt(n, t._query).then((n => new QuerySnapshot(e, r, t, n)));
}
 ...
 */ function getDocsFromCache(t) {
    t = j(t, _);
    const e = j(t.firestore, a), n = U(e), r = new K(e);
    return Dt(n, t._query).then((n => new QuerySnapshot(e, r, t, n)));
}
...
function setDoc(t, e, n) {
    ...
    return executeWrite(r, [ It(o, "setDoc", t._key, s, null !== t.converter, n).toMutation(t._key, At.none()) ]);
}
...
function updateDoc(t, e, n, ...r) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = Ht(e)) || e instanceof St ? Tt(o, "updateDoc", t._key, e, n, r) : bt(o, "updateDoc", t._key, e);
    return executeWrite(s, [ i.toMutation(t._key, At.exists(!0)) ]);
}
 ...
 */ function deleteDoc(t) {
    return executeWrite(j(t.firestore, a), [ new Pt(t._key, At.none()) ]);
}
 ...
 * the document.
 */ function addDoc(t, e) {
    const n = j(t.firestore, a), r = Ft(t), s = __PRIVATE_applyFirestoreDataConverter(t.converter, e), o = m(t.firestore);
    return executeWrite(n, [ It(o, "addDoc", r._key, s, null !== t.converter, {}).toMutation(r._key, At.exists(!1)) ]).then((() => r));
}
...
function onSnapshot(t, ...e) {
    ...
    let o, i, c;
    if (t instanceof d) i = j(t.firestore, a), c = Vt(t._key.path), o = {
        next: n => {
 ...
 */
        return function __PRIVATE_onSnapshotQuerySnapshotBundle(t, e, n, r, s) {
            let a, o = !1;
            const i = Ot(t, e.bundle);
            return i.then((() => Mt(t, e.bundleName))).then((t => {
                if (t && !o) {
 ...
 */ function setIndexConfiguration(t, e) {
    ...
    return Bt("Cannot enable indexes when persistence is disabled"), Promise.resolve();
    const r = function __PRIVATE_parseIndexes(t) {
        ...
        if (Array.isArray(e.indexes)) for (const t of e.indexes) {
            ...
            if (Array.isArray(t.fields)) for (const e of t.fields) {
                const t = __PRIVATE_tryGetString(e, "fieldPath"), n = Lt("setIndexConfiguration", t);
                "CONTAINS" === e.arrayConfig ? r.push(new $t(n, 2 /* IndexKind.CONTAINS */)) : "ASCENDING" === e.order ? r.push(new $t(n, 0 /* IndexKind.ASCENDING */)) : "DESCENDING" === e.order && r.push(new $t(n, 1 /* IndexKind.DESCENDING */));
            }
            n.push(new Wt(Wt.UNKNOWN_ID, e, r, kt.empty()));
        }
        return n;
    }(e);
    return Nt(n, r);
 ...
 */ function deleteAllPersistentCacheIndexes(t) {
    ...
    Jt(e).then((t => Gt("deleting all persistent cache indexes succeeded"))).catch((t => Bt("deleting all persistent cache indexes failed", t)));
}

function __PRIVATE_setPersistentCacheIndexAutoCreationEnabled(t, e) {
    const n = U(t._firestore);
    jt(n, e).then((t => Gt(`setting persistent cache index auto creation isEnabled=${e} succeeded`))).catch((t => Bt(`setting persistent cache index auto creation isEnabled=${e} failed`, t)));
}
 ...
 */ class __PRIVATE_TestingHooksSpiImpl {
    ...
    static get instance() {
        return ee || (ee = new __PRIVATE_TestingHooksSpiImpl, Ut(ee)), ee;
    }
    u(t) {
 ...
 */ !function __PRIVATE_registerFirestore(h, d = !0) {
    ...
    }), "PUBLIC").setMultipleInstances(!0)), e(Yt, Kt, h), 
    // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
    e(Yt, Kt, "__BUILD_TARGET__");
}();

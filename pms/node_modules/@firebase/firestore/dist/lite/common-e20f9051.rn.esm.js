 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    W() {
        if (this.G) throw new FirestoreError(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }
...
/** A "context" object passed around while parsing user data. */ class ParseContextImpl {
    ...
    validatePathSegment(e) {
        ...
        if (__PRIVATE_isWrite(this.dataSource) && z.test(e)) throw this.createError('Document fields cannot begin and end with "__"');
    }
}
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayUnionFieldValueImpl && o(this.H, e.H);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayRemoveFieldValueImpl && o(this.H, e.H);
    }
}
...
/** Parse update data from an update() call. */ function __PRIVATE_parseUpdateData(e, t, r, n) {
    ...
    forEach(n, ((e, n) => {
        ...
        // performing validation.
                n = u(n);
        const _ = i.childContextForFieldPath(a);
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, r, n, i, s) {
    const o = e.createContext(1 /* UserDataSource.Update */ , t, r), a = [ __PRIVATE_fieldPathFromArgument(t, n, r) ], _ = [ i ];

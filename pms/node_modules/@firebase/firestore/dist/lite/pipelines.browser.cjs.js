import { F as Firestore, h as __PRIVATE_LiteUserDataWriter, j as __PRIVATE_newUserDataReader, r as FirestoreError, ax as V, a7 as documentId$1, i as __PRIVATE_fieldPathFromArgument, ay as __PRIVATE_hardAssert, az as __PRIVATE_parseData, aA as __PRIVATE_isString, aB as __PRIVATE_toStringValue, aC as __PRIVATE_isNumber, X as VectorValue, av as vector, aD as __PRIVATE_isPlainObject, aE as __PRIVATE_isCollectionReference, G as DocumentReference, s as d, E as CollectionReference, e as __PRIVATE_getDatastore, d as __PRIVATE_cast, aF as __PRIVATE_invokeExecutePipeline, O as ObjectValue, aG as FieldPath$1, f as __PRIVATE_mapToArray, aH as toMapValue, aI as toNumber, aJ as __PRIVATE_toPipelineValue, aK as __PRIVATE_isUserData, u as fail, aL as __PRIVATE_isCollectionGroupQuery, aM as __PRIVATE_isDocumentQuery, a6 as doc, aN as __PRIVATE_queryNormalizedOrderBy, aO as FieldFilter, aP as CompositeFilter } from './common-d5329a05.cjs.js';
export { C as Bytes, G as DocumentReference, m as FieldPath, H as FieldValue, F as Firestore, I as GeoPoint, Q as Query, L as QueryDocumentSnapshot, W as Timestamp, X as VectorValue } from './common-d5329a05.cjs.js';
 ...
 */ class OptionsUtil {
    ...
    getOptionsProto(e, t, r) {
        ...
        // APPLY OPTIONS OVERRIDES
                if (r) {
            const t = new Map(__PRIVATE_mapToArray(r, ((t, r) => [ FieldPath$1.fromServerFormat(r), void 0 !== t ? __PRIVATE_parseData(t, e) : null ])));
            s.setAll(t);
        }
...
class __PRIVATE_DocumentsSource extends Stage {
    ...
    constructor(e, t) {
        ...
        if (s.size !== r.length) throw new FirestoreError(d.INVALID_ARGUMENT, "Duplicate document paths are not allowed in DocumentsSource");
        this.re = r, this.se = s;
    }
    /**
     * @internal
...
class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), __PRIVATE_toStringValue(__PRIVATE_Replace.ie) ]
        };
    }
    _readUserData(e) {
 ...
 */ function execute(e) {
    ...
    const t = __PRIVATE_getDatastore(e._db), r = __PRIVATE_cast(e._db, Firestore), s = __PRIVATE_newUserDataReader(r).createContext(3 /* UserDataSource.Argument */ , "execute");
    e._readUserData(s);
    const i = new __PRIVATE_LiteUserDataWriter(r), o = new __PRIVATE_StructuredPipelineOptions({}, {});
    o._readUserData(s);
    const a = new StructuredPipeline(e, o);
    return __PRIVATE_invokeExecutePipeline(t, a).then((t => {
